...
export const wardrobeTypeList: WardrobeType[] = [
  {
    ...
    sections: {
      sectionA: {
        ...
        minColumns: 1,
        maxColumns: 1,
        columns: [{ id: "sectionA-col-1", width: 56 }],
      },
    },
  },
  {
    ...
    sections: {
      sectionA: {
        ...
        maxColumns: 4,
        columns: [
          { id: "sectionA-col-1", width: 68 },
          { id: "sectionA-col-2", width: 86 },
        ],
      },
      sectionB: {
        width: 160,
        ...
        maxColumns: 4,
        columns: [
          { id: "sectionB-col-1", width: 78 },
          { id: "sectionB-col-2", width: 76 },
        ],
      },
    },
  },
  {
    ...
    sections: {
      sectionA: {
        ...
        maxColumns: 8,
        columns: [
          { id: "sectionA-col-1", width: 86 },
          { id: "sectionA-col-2", width: 80 },
          { id: "sectionA-col-3", width: 86 },
        ],
      },
      sectionB: {
        width: 160,
        ...
        maxColumns: 4,
        columns: [
          { id: "sectionB-col-1", width: 77 },
          { id: "sectionB-col-2", width: 77 },
        ],
      },
      sectionC: {
        width: 160,
        ...
        maxColumns: 4,
        columns: [
          { id: "sectionC-col-1", width: 77 },
          { id: "sectionC-col-2", width: 77 },
        ],
      },
    },
  },
